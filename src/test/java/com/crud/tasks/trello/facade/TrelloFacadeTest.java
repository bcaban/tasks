...
public class TrelloFacadeTest {
    ...
    public void shouldCreateCard() {
        ...
        //When
        CreatedTrelloCardDto createdTrelloCardDto1 = trelloFacade.createCard(trelloMapper.mapToCardDto(trelloCard));

        //Then
        assertNotNull(createdTrelloCardDto1);
        verify(trelloService, times(1)).createdTrelloCard(trelloMapper.mapToCardDto(trelloCard));
    }
}